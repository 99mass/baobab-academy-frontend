                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-1">
                    ...
                    {completedLessons > 0 && !isChapterCompleted && (
                      <div className="w-16 bg-gray-200 rounded-full h-1">
                        <div
                          className="bg-[#0096F0] h-1 rounded-full transition-all duration-300"
                          style={{
                            width: `${
                              (completedLessons / totalLessons) * 100
                            }%`,
                          ...
                          <div className="flex-shrink-0">
                            {lessonStatus === "completed" ? (
                              ...
                              <div className="relative">
                                <div className="w-5 h-5 border-2 border-gray-300 rounded-full" />
                                <div className="absolute inset-0 flex items-center justify-center">
                                  <Clock className="w-3 h-3 text-[#0096F0]" />
                                </div>
                              </div>
                            ) : (
                              <div className="w-5 h-5 border-2 border-gray-300 rounded-full" />
      ...
      <div className="flex-1 flex flex-col pt-5">
        <div className="bg-white border-b border-gray-200 p-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="font-semibold text-gray-900 flex">
                <FolderOpen className="w-6 h-6 text-[#0096F0] mr-2" />
                {currentLesson.title}
              </h1>
            </div>
          </div>
            ...
            <div className="p-8">
              <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                  <div className="flex items-center space-x-3 mb-6">
                    {currentLesson.contentType === "VIDEO" && (
                      <Video className="w-6 h-6 text-[#0096F0]" />
                    )}
                    {currentLesson.contentType === "TEXT" && (
                      <FileText className="w-6 h-6 text-[#0096F0]" />
                    )}
                    {currentLesson.contentType === "DOCUMENT" && (
                      <Download className="w-6 h-6 text-[#0096F0]" />
                    )}
